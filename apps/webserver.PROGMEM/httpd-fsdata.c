...
const struct httpd_fsdata_file file_header_html[] = {{file_fade_png, data_header_html, data_header_html + 13, (int) sizeof(data_header_html) - 13}};

const struct httpd_fsdata_file file_tcp_shtml[] = {{file_header_html, data_tcp_shtml, data_tcp_shtml + 11, (int) sizeof(data_tcp_shtml) - 11}};

const struct httpd_fsdata_file file_stats_shtml[] = {{file_tcp_shtml, data_stats_shtml, data_stats_shtml + 13, (int) sizeof(data_stats_shtml) - 13}};

const struct httpd_fsdata_file file_404_html[] = {{file_stats_shtml, data_404_html, data_404_html + 10, (int) sizeof(data_404_html) - 10}};

const struct httpd_fsdata_file file_files_shtml[] = {{file_404_html, data_files_shtml, data_files_shtml + 13, (int) sizeof(data_files_shtml) - 13}};

const struct httpd_fsdata_file file_footer_html[] = {{file_files_shtml, data_footer_html, data_footer_html + 13, (int) sizeof(data_footer_html) - 13}};

const struct httpd_fsdata_file file_processes_shtml[] = {{file_footer_html, data_processes_shtml, data_processes_shtml + 17, (int) sizeof(data_processes_shtml) - 17}};

const struct httpd_fsdata_file file_style_css[] = {{file_processes_shtml, data_style_css, data_style_css + 11, (int) sizeof(data_style_css) - 11}};

const struct httpd_fsdata_file file_413_html[] = {{file_style_css, data_413_html, data_413_html + 10, (int) sizeof(data_413_html) - 10}};

const struct httpd_fsdata_file file_index_html[] = {{file_413_html, data_index_html, data_index_html + 12, (int) sizeof(data_index_html) - 12}};
